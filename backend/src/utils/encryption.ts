...
export function decodeAes256KeyFromBase64(keyBase64: string): Buffer {
...
export function encryptAes256Gcm(params: { plaintext: string; key: Buffer }): EncryptedPayload {
...
export function decryptAes256Gcm(params: { payload: EncryptedPayload; key: Buffer }): string {
